...
Solution générale \-: Le canari s'execute deux fois plus souvent que le watchdog. Le canarai incrémente une variable. Cette variable sera checkée dans le watchdog, si la valeur est la même que la dernière vérification, cela signifie que le canarai n'a pas pu l'incrémenter pendant 2 périodes. Donc le C\-P\-U est surchargé et on suspent les tâches courantes.
...
Descripteur de la tâche watchdog 

Définition à la ligne 41 du fichier watchdog.\-c.



Référencé par end\-\_\-watchdog(), start\-\_\-watchdog(), et watchdog().
